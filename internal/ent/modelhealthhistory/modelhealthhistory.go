...
const (
	// Label holds the string label denoting the modelhealthhistory type in the database.
	Label = "model_health_history"
	...
	EdgeChannel = "channel"
	// Table holds the table name of the modelhealthhistory in the database.
	Table = "model_health_histories"
	// ChannelTable is the table that holds the channel relation/edge.
	ChannelTable = "model_health_histories"
...
// Columns holds all SQL columns for modelhealthhistory fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ModelHealthHistory queries.
