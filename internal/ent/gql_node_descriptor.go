...
func (_m *Channel) Node(ctx context.Context) (node *Node, err error) {
	...
	err = _m.QueryModelHealthSnapshots().
		Select(modelhealthsnapshot.FieldID).
	...
	err = _m.QueryModelHealthHistories().
		Select(modelhealthhistory.FieldID).
...
func (_m *ChannelProbe) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(_m.ActiveProbeLatencyMs); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "float64",
		Name:  "active_probe_latency_ms",
		Value: string(buf),
	}
	if buf, err = json.Marshal(_m.ProbeModelLatencyMs); err != nil {
		return nil, err
	}
	node.Fields[6] = &Field{
		Type:  "float64",
		Name:  "probe_model_latency_ms",
		Value: string(buf),
	}
...
// Node implements Noder interface
func (_m *ModelHealthHistory) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     _m.ID,
		Type:   "ModelHealthHistory",
		Fields: make([]*Field, 9),
...
// Node implements Noder interface
func (_m *ModelHealthSnapshot) Node(ctx context.Context) (node *Node, err error) {
	node = &Node{
		ID:     _m.ID,
		Type:   "ModelHealthSnapshot",
		Fields: make([]*Field, 9),
...
func (_m *Request) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(_m.RequestPath); err != nil {
		return nil, err
	}
	node.Fields[10] = &Field{
		Type:  "string",
