...
import { BarChart3, Brain, Key, Zap, ChevronDown, Route } from 'lucide-react';
...
import { LoadBalancerPreview } from './components/load-balancer-preview';
...
export default function DashboardPage() {
  ...
  return (
    <div className='flex-1 space-y-6 p-8 pt-6'>
      ...
      <CollapsibleSection
        title={t('dashboard.sections.loadBalancerPreview')}
        icon={<Route className='text-primary h-4 w-4' />}
        storageKey='load-balancer-preview'
      >
        <LoadBalancerPreview />
      </CollapsibleSection>
    </div>
